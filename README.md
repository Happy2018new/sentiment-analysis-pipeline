...
2. Usge
   ...
   ```shell
   usage: main.py [-h] --input-stream INPUT_STREAM --output-csv-dir OUTPUT_CSV_DIR --output-plot-dir OUTPUT_PLOT_DIR
                  [--visual-comments-chunks VISUAL_COMMENTS_CHUNKS] [--visual-tokens-percent VISUAL_TOKENS_PERCENT]
